...
while(loop){
    ...
    if(input === "Pakistani Rupee"){
        if(output === "US Dollar"){
            console.log(`The ${amount} pakistani Rupee is equal to ${amount / 277.58} US Dollar`)
        }else if(output === "Saudi Riyal"){
            console.log(`The ${amount} pakistani Rupee is equal to ${amount / 73.92} Saudi Riyal`)
        }


    }else if(input === "US Dollar"){
        if(output ==="Pakistani Rupee"){
            console.log(`The ${amount} US Dollar is equal to ${amount * 277.58} pakistani Rupee`)
        }else if(output === "Saudi Riyal")
    ...
    if(output ==="Pakistani Rupee"){
        console.log(`The ${amount} saudi Riyal is ${amount * 73.92} pakistani Rupee`)
